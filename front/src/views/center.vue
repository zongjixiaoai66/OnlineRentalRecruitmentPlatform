<template>
  <div>
    ...
    >  
     <el-row>
                    <el-col :span="12">
           <el-form-item v-if="flag=='fangdong'"  label='房东姓名' prop="fangdongName">
               <el-input v-model="ruleForm.fangdongName"  placeholder='房东姓名' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
           <el-form-item v-if="flag=='fangdong'"  label='房东手机号' prop="fangdongPhone">
               <el-input v-model="ruleForm.fangdongPhone"  placeholder='房东手机号' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
           <el-form-item v-if="flag=='fangdong'"  label='房东身份证号' prop="fangdongIdNumber">
               <el-input v-model="ruleForm.fangdongIdNumber"  placeholder='房东身份证号' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
             <el-form-item v-if="flag=='fangdong'" label='房东头像' prop="fangdongPhoto">
                 <file-upload
                         tip="点击上传照片"
                         action="file/upload"
                         :limit="3"
         ...
         <el-col :span="12">
           <el-form-item v-if="flag=='fangdong'"  label='房东邮箱' prop="fangdongEmail">
               <el-input v-model="ruleForm.fangdongEmail"  placeholder='房东邮箱' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
             <el-form-item v-if="flag=='fangdong'"  label='余额' prop="newMoney">
         ...
         <el-col :span="12">
           <el-form-item v-if="flag=='gongsi'"  label='企业名称' prop="gongsiName">
               <el-input v-model="ruleForm.gongsiName"  placeholder='企业名称' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
             <el-form-item v-if="flag=='gongsi'"  label='企业类型' prop="gongsiTypes">
                 <el-select v-model="ruleForm.gongsiTypes"  placeholder='请选择企业类型'>
                     <el-option
         ...
         <el-col :span="12">
             <el-form-item v-if="flag=='gongsi'" label='企业封面' prop="gongsiPhoto">
                 <file-upload
                         tip="点击上传照片"
                         action="file/upload"
                         :limit="3"
         ...
         <el-col :span="24">
             <el-form-item v-if="flag=='gongsi'"  label="企业简介" prop="gongsiContent">
                 <editor
...
|| flag=='fangdong')"  label="性别" prop="sexTypes">
...
// 注册表 企业 的级联表
  ...
  methods: {
    ...
    onUpdateHandler() {
                         if((!this.ruleForm.fangdongName)&& 'fangdong'==this.flag){
                             this.$message.error('房东姓名不能为空');
                             return
                         }

                             if( 'fangdong' ==this.flag && this.ruleForm.fangdongPhone&&(!isMobile(this.ruleForm.fangdongPhone))){
                                 this.$message.error(`手机应输入手机格式`);
                                 return
                             }
                         if((!this.ruleForm.fangdongIdNumber)&& 'fangdong'==this.flag){
                             this.$message.error('房东身份证号不能为空');
                             return
                         }

                         if((!this.ruleForm.fangdongPhoto)&& 'fangdong'==this.flag){
                             this.$message.error('房东头像不能为空');
                             return
                         }

                             if( 'fangdong' ==this.flag && this.ruleForm.fangdongEmail&&(!isEmail(this.ruleForm.fangdongEmail))){
