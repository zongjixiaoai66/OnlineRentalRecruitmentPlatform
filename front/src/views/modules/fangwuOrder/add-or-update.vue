    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='fangwu'">
                    <el-form-item class="select" v-if="type!='info'"  label="房屋" prop="fangwuId">
                        <el-select v-model="ruleForm.fangwuId" :disabled="ro.fangwuId" filterable placeholder="请选择房屋" @change="fangwuChange">
                            <el-option
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="订单编号" prop="fangwuOrderUuidNumber">
                       <el-input v-model="ruleForm.fangwuOrderUuidNumber"
                                 placeholder="订单编号" clearable  :readonly="ro.fangwuOrderUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="订单编号" prop="fangwuOrderUuidNumber">
                           <el-input v-model="ruleForm.fangwuOrderUuidNumber"
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="实付价格" prop="fangwuOrderTruePrice">
                       <el-input v-model="ruleForm.fangwuOrderTruePrice"
                                 placeholder="实付价格" clearable  :readonly="ro.fangwuOrderTruePrice"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="实付价格" prop="fangwuOrderTruePrice">
                           <el-input v-model="ruleForm.fangwuOrderTruePrice"
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="订单类型" prop="fangwuOrderTypes">
                        <el-select v-model="ruleForm.fangwuOrderTypes" :disabled="ro.fangwuOrderTypes" placeholder="请选择订单类型">
                            <el-option
                                v-for="(item,index) in fangwuOrderTypesOptions"
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="订单类型" prop="fangwuOrderValue">
                        <el-input v-model="ruleForm.fangwuOrderValue"
    ...
    export default {
        data() {
            return {
                ...
                yonghuForm: {},
                ro:{
                    fangwuOrderUuidNumber: false,
                    fangwuId: false,
                    yonghuId: false,
                    fangwuOrderTruePrice: false,
                    fangwuOrderTypes: false,
                    insertTime: false,
                },
                ruleForm: {
                    fangwuOrderUuidNumber: new Date().getTime(),
                    fangwuId: '',
                    yonghuId: '',
                    fangwuOrderTruePrice: '',
                    fangwuOrderTypes: '',
                    insertTime: '',
                },
                fangwuOrderTypesOptions : [],
                fangwuOptions : [],
                yonghuOptions : [],
                rules: {
                   fangwuOrderUuidNumber: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=fangwu_order_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.fangwuOrderTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`fangwuOrder/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.fangwuOrderCrossAddOrUpdateFlag = false;
                                        this.parent.search();
