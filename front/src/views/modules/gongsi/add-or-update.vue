        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="企业名称" prop="gongsiName">
                       <el-input v-model="ruleForm.gongsiName"
                                 placeholder="企业名称" clearable  :readonly="ro.gongsiName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="企业类型" prop="gongsiTypes">
                        <el-select v-model="ruleForm.gongsiTypes" :disabled="ro.gongsiTypes" placeholder="请选择企业类型">
                            <el-option
               ...
               <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.gongsiContent"  label="企业简介" prop="gongsiContent">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.gongsiContent" label="企业简介" prop="gongsiContent">
