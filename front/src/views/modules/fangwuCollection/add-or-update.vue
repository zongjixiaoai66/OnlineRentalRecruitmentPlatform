    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="类型" prop="fangwuCollectionTypes">
                        <el-select v-model="ruleForm.fangwuCollectionTypes" :disabled="ro.fangwuCollectionTypes" placeholder="请选择类型">
                            <el-option
                                v-for="(item,index) in fangwuCollectionTypesOptions"
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="类型" prop="fangwuCollectionValue">
                        <el-input v-model="ruleForm.fangwuCollectionValue"
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    fangwuId: false,
                    yonghuId: false,
                    fangwuCollectionTypes: false,
                    insertTime: false,
                },
                ruleForm: {
                    fangwuId: '',
                    yonghuId: '',
                    fangwuCollectionTypes: '',
                    insertTime: '',
                },
                fangwuCollectionTypesOptions : [],
                fangwuOptions : [],
                yonghuOptions : [],
                rules: {
                   fangwuId: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=fangwu_collection_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.fangwuCollectionTypesOptions = data.data.list;
                    }
                });
