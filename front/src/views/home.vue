...
<div class="content">
  ...
  <div style="width: 100%;height: 100%" v-if="sessionTable=='users' && false">
    <div class="text main-text">欢迎使用 {{this.$project.projectName}}</div>
  </div>
  <div style="width: 100%;height: 100%;display:flex ">
<!--    <div style="width: 40%;height: 50%">-->
<!--&lt;!&ndash;        <div id="statistic1" style="width:100%;height:600px;"></div>&ndash;&gt;-->
<!--    </div>-->
...
<!--      </el-date-picker>-->
      ...
      <div style="display: flex;     flex-wrap: wrap;">
        <div id="statistic1" style="width:50%;height:600px;"></div>
        <div id="statistic2" style="width:50%;height:600px;"></div>
        <div id="statistic3" style="width:50%;height:600px;"></div>
        <div id="statistic4" style="width:50%;height:600px;"></div>
      </div>
...
<!--      &lt;!&ndash;          v-model="echartsDate"&ndash;&gt;-->
