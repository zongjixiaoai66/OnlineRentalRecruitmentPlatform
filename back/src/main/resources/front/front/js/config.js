...
var centerMenu = [
    ...
    ,{
        name: '房屋收藏',
        url: '../fangwuCollection/list.html'
    }
    ,{
        name: '房屋订单',
        url: '../fangwuOrder/list.html'
    }
    ,{
        name: '简历',
        url: '../jianli/list.html'
    }
    ,{
        name: '简历投递',
        url: '../toudi/list.html'
...
// 已废弃,不用了
var adminurl =  "http://localhost:8080/zaixianzufangzhaopinoingtai/admin/dist/index.html#/login";
