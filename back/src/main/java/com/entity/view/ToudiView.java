...
public class ToudiView extends ToudiEntity implements Serializable {
	...
	*/
	...
	private String mianshiYesnoValue;
	...
	* 获取： 投递状态的值
	*/
	public String getMianshiYesnoValue() {
		return mianshiYesnoValue;
	}
	/**
	* 设置： 投递状态的值
	*/
	public void setMianshiYesnoValue(String mianshiYesnoValue) {
		this.mianshiYesnoValue = mianshiYesnoValue;
	}
	...
	public String toString() {
		return "ToudiView{" +
			", mianshiYesnoValue=" + mianshiYesnoValue +
