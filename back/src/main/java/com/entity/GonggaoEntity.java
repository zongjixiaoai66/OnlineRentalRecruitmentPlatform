...
public class GonggaoEntity<T> implements Serializable {
     ...
     * 平台资讯名称
     */
    @ColumnInfo(comment="平台资讯名称",type="varchar(200)")
     ...
     * 平台资讯图片
     */
    @ColumnInfo(comment="平台资讯图片",type="varchar(200)")
     ...
     * 平台资讯类型
     */
    @ColumnInfo(comment="平台资讯类型",type="int(11)")
     ...
     * 平台资讯详情
     */
    @ColumnInfo(comment="平台资讯详情",type="longtext")
