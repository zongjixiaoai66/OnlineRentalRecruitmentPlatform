...
public class FangwuCollectionController {
    ...
    private static final String TABLE_NAME = "fangwuCollection";
    ...
    */
    ...
    public R save(@RequestBody FangwuCollectionEntity fangwuCollection, HttpServletRequest request){
        ...
        Wrapper<FangwuCollectionEntity> queryWrapper = new EntityWrapper<FangwuCollectionEntity>()
            ...
            .eq("fangwu_collection_types", fangwuCollection.getFangwuCollectionTypes())
            ;
    ...
    */
    ...
    public R update(@RequestBody FangwuCollectionEntity fangwuCollection, HttpServletRequest request) throws NoSuchFieldException, ClassNotFoundException, IllegalAccessException, InstantiationException {
        logger.debug("update方法:,,Controller:{},,fangwuCollection:{}",this.getClass().getName(),fangwuCollection.toString());
        FangwuCollectionEntity oldFangwuCollectionEntity = fangwuCollectionService.selectById(fangwuCollection.getId());//查询原先数据
...
//            fangwuCollection.setYonghuId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
    ...
    */
    ...
    public R delete(@RequestBody Integer[] ids, HttpServletRequest request){
        ...
        List<FangwuCollectionEntity> oldFangwuCollectionList =fangwuCollectionService.selectBatchIds(Arrays.asList(ids));//要删除的数据
...
//                            fangwuCollectionEntity.setFangwuCollectionTypes(Integer.valueOf(data.get(0)));   //类型 要改的
    ...
    */
    ...
    public R add(@RequestBody FangwuCollectionEntity fangwuCollection, HttpServletRequest request){
        ...
        Wrapper<FangwuCollectionEntity> queryWrapper = new EntityWrapper<FangwuCollectionEntity>()
            ...
            .eq("yonghu_id", fangwuCollection.getYonghuId())
            .eq("fangwu_collection_types", fangwuCollection.getFangwuCollectionTypes())
//            .notIn("fangwu_collection_types", new Integer[]{102})
            ;
        logger.info("sql语句:"+queryWrapper.getSqlSegment());
        FangwuCollectionEntity fangwuCollectionEntity = fangwuCollectionService.selectOne(queryWrapper);
        if(fangwuCollectionEntity==null){
