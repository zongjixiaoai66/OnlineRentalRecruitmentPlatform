...
, "usersId"});//把级联的数据添加到view中,并排除id和创建时间字段,当前表的级联注册表
            ...
            //级联表 房东
            //级联表
            FangdongEntity fangdong = fangdongService.selectById(forum.getFangdongId());
            if(fangdong != null){
            BeanUtils.copyProperties( fangdong , view ,new String[]{ "id", "createTime", "insertTime", "updateTime", "yonghuId"
, "fangdongId"
, "gongsiId"
, "usersId"});//把级联的数据添加到view中,并排除id和创建时间字段,当前表的级联注册表
    ...
    */
    ...
    public R save(@RequestBody ForumEntity forum, HttpServletRequest request){
        ...
        if(false)
            ...
            forum.setFangdongId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
        ...
        Wrapper<ForumEntity> queryWrapper = new EntityWrapper<ForumEntity>()
            ...
            .eq("fangdong_id", forum.getFangdongId())
...
//                            forumEntity.setFangdongId(Integer.valueOf(data.get(0)));   //房东 要改的
